<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-5215%20unit%20%7C%20360%20E2E-brightgreen" alt="5215 Unit | 360 E2E Tests">
...
| Metric | Count |
|--------|-------|
| Unit tests | **5,215** across 210 files (14,598 assertions) |
...
```bash
bun test              # 5215+ server tests (~120s)
...
| Database | [SQLite](https://bun.sh/docs/api/sqlite) — WAL mode, FTS5, 70 migrations |
