...
export const SaveMemoryParams = {
    ...
    book: z.string().optional().describe('Book key for multi-page memories. Creates page 1 if new, appends page if existing. Each page is a separate encrypted ASA.'),
};
...
export const SAVE_MEMORY_JSON_SCHEMA = {
    ...
    properties: {
        key: { type: 'string', description: 'A short descriptive key for this memory (e.g. "user-preferences", "project-status")' },
        content: { type: 'string', description: 'The content to remember' },
        book: { type: 'string', description: 'Book key for multi-page memories. Creates page 1 if new, appends page if existing.' },
    },
