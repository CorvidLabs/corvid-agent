...
export const TOOL_CATEGORIES: ToolCategory[] = [
  {
    ...
    description: 'Send messages, save/recall memories, manage on-chain storage',
  },
  {
    name: 'agents',
    label: 'Agent Management',
    description: 'List agents, discover remote agents, launch councils, manage contacts',
  },
  {
    name: 'work',
    label: 'Session & Work',
    description: 'Manage sessions, credits, projects, work tasks, schedules, and workflows',
  },
  ...
  {
    name: 'notifications',
    label: 'Notifications & Reputation',
    description: 'Owner notifications, reputation scoring, attestations',
  },
...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { name: 'corvid_save_memory', description: 'Save a memory to short-term SQLite storage', category: 'communication' },
  {
    ...
    description: 'Promote a short-term memory to long-term on-chain ARC-69 storage',
    category: 'communication',
  },
  {
    name: 'corvid_recall_memory',
    description: 'Recall memories by key, query, or list recent',
    category: 'communication',
  },
  { name: 'corvid_delete_memory', description: 'Delete (forget) an on-chain ARC-69 memory', category: 'communication' },
  {
    ...
    description: 'Read memories directly from Algorand blockchain',
    category: 'communication',
  },
  {
    name: 'corvid_sync_on_chain_memories',
    description: 'Sync on-chain memories back to local SQLite cache',
    category: 'communication',
  },
  ...
  // ── Shared Library (CRVLIB) ───────────────────────────────────────────
  {
    ...
    description: 'Publish or update a shared library entry readable by all agents',
    category: 'communication',
  },
  {
  ...
  },
  {
    ...
    description: 'List all shared library entries directly from on-chain',
    category: 'communication',
  },
  {
    name: 'corvid_library_delete',
    description: 'Delete a shared library entry (soft or hard)',
    category: 'communication',
  },

  // ── Discord Messaging ─────────────────────────────────────────────────
  {
    name: 'corvid_discord_send_message',
  ...
  // ── Agent Management ─────────────────────────────────────────────────
  {
    ...
    description: 'List all available agents with names, IDs, and wallets',
    category: 'agents',
  },
  {
    name: 'corvid_discover_agent',
    description: "Fetch a remote agent's A2A Agent Card for capabilities",
    category: 'agents',
  },
  {
    name: 'corvid_invoke_remote_agent',
    description: 'Send a task to a remote A2A agent and wait for result',
    category: 'agents',
  },
  {
    name: 'corvid_launch_council',
    description: 'Launch a multi-agent council deliberation on a topic',
    category: 'agents',
    conditional: true,
  },
  {
    name: 'corvid_flock_directory',
    description: 'Manage the on-chain Flock Directory agent registry',
    category: 'agents',
  },
  {
    name: 'corvid_lookup_contact',
    description: 'Look up a contact by name or platform identifier',
    category: 'agents',
  },
  ...
  { name: 'corvid_extend_timeout', description: 'Request more time for your current session', category: 'work' },
  {
    ...
    description: 'Restart the corvid-agent server (idempotent, prevents restart loops)',
    category: 'work',
  },
  { name: 'corvid_check_credits', description: 'Check credit balance for a wallet address', category: 'work' },
  {
    name: 'corvid_grant_credits',
    description: 'Grant free credits to a wallet address',
    category: 'work',
    restricted: true,
  },
  {
  ...
  },
  {
    ...
    description: 'List all available projects with IDs and directories',
    category: 'work',
  },
  { name: 'corvid_current_project', description: "Show the current agent's default project", category: 'work' },
  {
    ...
    description: 'Create a work task that spawns a new agent session on a branch',
    category: 'work',
    conditional: true,
  },
  {
  ...
  },
  {
    ...
    description: 'List work tasks, optionally filtered by status',
    category: 'work',
    conditional: true,
  },
  {
    ...
    description:
      'Manage automated cron/interval schedules across all agents. Use action="list" without agent_id to see all schedules.',
    category: 'work',
  },
  {
    name: 'corvid_manage_workflow',
    description: 'Manage graph-based workflows for multi-step orchestration',
    category: 'work',
  },
  ...
  { name: 'corvid_web_search', description: 'Search the web using Brave Search', category: 'research' },
  {
    ...
    description: 'Research a topic in depth with multi-angle search',
    category: 'research',
  },
  {
    name: 'corvid_browser',
    description: 'Browser automation with real Chrome (navigate, click, type, screenshot)',
    category: 'research',
    conditional: true,
  },
  ...
  { name: 'corvid_github_list_issues', description: 'List issues for a repository', category: 'github' },
  {
    ...
    description: 'Get repository info (stars, forks, description)',
    category: 'github',
  },
  ...
  {
    name: 'corvid_ask_owner',
    description: 'Ask the owner a question and wait for response',
    category: 'notifications',
  },
  {
    name: 'corvid_configure_notifications',
    description: 'Manage notification channels (Discord, Telegram, GitHub, etc.)',
    category: 'notifications',
  },
  ...
  {
    name: 'corvid_publish_attestation',
    description: 'Publish a cryptographic reputation attestation on-chain',
    category: 'notifications',
  },
  {
    name: 'corvid_verify_agent_reputation',
    description: "Verify a remote agent's on-chain reputation",
    category: 'notifications',
  },
  ...
  // ── Code Tools ────────────────────────────────────────────────────────
  {
    ...
    description: 'Search for code symbols using AST parsing',
    category: 'code',
    conditional: true,
  },
  {
...
export function getToolCatalog(category?: string): { categories: ToolCategory[]; tools: ToolCatalogEntry[] } {
  const tools = category ? TOOL_CATALOG.filter((t) => t.category === category) : TOOL_CATALOG;
