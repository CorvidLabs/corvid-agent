 ...
 */
export function isToolBlockedForScheduler(toolName: string, actionType?: ScheduleActionType): boolean {
 ...
 */
export function checkSchedulerRateLimit(toolName: string, usage: Map<string, number>): string | null {
