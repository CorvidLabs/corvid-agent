...
import type { Agent, Project, SessionSource } from '../../../shared/types';
...
export async function handleSessionCommand(
  ...
  if (permLevel < PermissionLevel.STANDARD) {
    await respondEphemeral(
      interaction,
      'You need a higher role to create sessions. Try @mentioning the bot for a quick reply.',
    );
    return;
  }
