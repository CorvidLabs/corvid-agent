...
async function handleScheduleList(ctx: InteractionContext, interaction: DiscordInteractionData): Promise<void> {
...
async function handleScheduleTemplates(interaction: DiscordInteractionData): Promise<void> {
