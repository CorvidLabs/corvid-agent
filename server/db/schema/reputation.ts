/**
 * Schema definitions for the reputation domain.
 *
 * Tables: agent_reputation, reputation_attestations, reputation_events,
 *         response_feedback (v90)
 */
...
/** v90 — Response feedback for reputation (issue #1094) */
export const migrationV90: string[] = [
