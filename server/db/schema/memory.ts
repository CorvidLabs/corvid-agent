/**
 * Schema definitions for the memory domain.
 *
 * Tables: agent_memories, agent_memories_fts (FTS5 virtual table)
 * Includes: FTS sync triggers
 */
...
export const ftsStatements: string[] = [
...
/** FTS sync triggers to keep agent_memories_fts in sync with agent_memories */
export const ftsTriggers: string[] = [
