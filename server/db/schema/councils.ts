/**
 * Schema definitions for the councils & governance domain.
 *
 * Tables: councils, council_members, council_launches, council_launch_logs,
 *         council_discussion_messages, governance_proposals, governance_votes,
