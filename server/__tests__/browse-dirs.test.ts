...
import { getAllowedRoots, handleBrowseDirs, isPathAllowed } from '../routes/projects';
...
describe('getAllowedRoots', () => {
  ...
  it('includes registered project working directories', () => {
    db.query('INSERT INTO projects (id, name, working_dir) VALUES (?, ?, ?)').run('p1', 'Project 1', '/opt/myproject');
    db.query('INSERT INTO projects (id, name, working_dir) VALUES (?, ?, ?)').run('p2', 'Project 2', '/var/www/app');
...
describe('handleBrowseDirs', () => {
  ...
  it('allows browsing a registered project directory', async () => {
    ...
    db.query('INSERT INTO projects (id, name, working_dir) VALUES (?, ?, ?)').run('test-project', 'Test', projectDir);
  ...
  it('allows browsing a subdirectory of a registered project', async () => {
    ...
    db.query('INSERT INTO projects (id, name, working_dir) VALUES (?, ?, ?)').run(
      'tmp-project',
      'TmpProject',
      TEMP_DIR,
    );
