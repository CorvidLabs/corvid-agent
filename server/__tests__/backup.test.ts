...
describe('pruneBackups', () => {
    ...
    test('prunes oldest backups when exceeding max', () => {
        ...
        expect(remaining.sort()).toEqual([
            'corvid-agent-2026-01-04.db',
            'corvid-agent-2026-01-05.db',
        ]);
    });
...
describe('backupDatabase', () => {
    ...
    test('backup contains data', () => {
        ...
        db.query("INSERT INTO agents (id, name, model, system_prompt, tenant_id) VALUES ('a1', 'Test', 'model', 'prompt', 'default')").run();
