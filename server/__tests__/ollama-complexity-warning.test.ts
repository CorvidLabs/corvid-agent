...
import { buildOllamaComplexityWarning, isOllamaProvider } from '../lib/ollama-complexity-warning';
...
describe('buildOllamaComplexityWarning — complex tasks', () => {
  ...
  test('warning includes the model name', () => {
    ...
    const result = buildOllamaComplexityWarning('Refactor and optimize the authentication system', model, 'ollama');
    expect(result).not.toBeNull();
