...
import { BASH_WRITE_OPERATORS, isProtectedBashCommand, isProtectedPath } from '../process/protected-paths';
...
describe('isProtectedBashCommand', () => {
  ...
  test('blocks variable expansion combined with write operator', () => {
    // biome-ignore lint/suspicious/noTemplateCurlyInString: testing variable expansion detection
