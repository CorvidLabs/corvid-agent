...
import { RateLimiter, loadRateLimitConfig, getClientIp, checkRateLimit } from '../middleware/rate-limit';
...
describe('Rate Limit Key Behavior', () => {
    ...
    test('endpointRateLimitGuard with different tiers', () => {
        const endpointLimiter = new EndpointRateLimiter(makeEndpointConfig({
            defaults: {
