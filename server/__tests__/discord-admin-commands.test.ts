...
function getResponseText(): string {
  ...
  const body = fetchBodies[0] as {
    data?: { content?: string; embeds?: Array<{ title?: string; description?: string }> };
  };
...
describe('/admin commands', () => {
  test('rejects non-admin users', async () => {
    ...
    await callInteraction(bridge, makeInteraction('admin', [{ name: 'show', type: 1 }], '999000000000000001')); // non-admin user
  ...
  describe('channels', () => {
    test('add channel persists to DB', async () => {
      ...
      await callInteraction(
        bridge,
        makeInteraction('admin', [
          {
            name: 'channels',
            type: 2,
            options: [{ name: 'add', type: 1, options: [{ name: 'channel', type: 7, value: '400000000000000001' }] }],
          },
        ]),
      );
        ...
        makeInteraction('admin', [
          {
            name: 'channels',
            type: 2,
            options: [{ name: 'add', type: 1, options: [{ name: 'channel', type: 7, value: '100000000000000001' }] }],
          },
        ]),
      );
        ...
        makeInteraction('admin', [
          {
            name: 'users',
            type: 2,
            options: [{ name: 'add', type: 1, options: [{ name: 'user', type: 6, value: '500000000000000001' }] }],
          },
        ]),
      );
        ...
        makeInteraction('admin', [
          {
            name: 'users',
            type: 2,
            options: [{ name: 'remove', type: 1, options: [{ name: 'user', type: 6, value: '500000000000000001' }] }],
          },
        ]),
      );
            ...
            options: [
              {
                name: 'remove',
                type: 1,
                options: [{ name: 'role', type: 8, value: '600000000000000001' }],
              },
            ],
          },
        ]),
            ...
            options: [
              {
                name: 'remove',
                type: 1,
                options: [{ name: 'role', type: 8, value: '600000000000000099' }],
              },
            ],
          },
        ]),
  ...
  describe('public', () => {
    test('enable public mode', async () => {
      ...
      await callInteraction(
        bridge,
        makeInteraction('admin', [{ name: 'public', type: 1, options: [{ name: 'enabled', type: 5, value: true }] }]),
      );
    ...
    test('disable public mode', async () => {
      ...
      await callInteraction(
        bridge,
        makeInteraction('admin', [{ name: 'public', type: 1, options: [{ name: 'enabled', type: 5, value: false }] }]),
      );
  ...
  describe('show', () => {
    test('shows full config summary', async () => {
      ...
      await callInteraction(bridge, makeInteraction('admin', [{ name: 'show', type: 1 }]));
