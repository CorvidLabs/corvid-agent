...
describe('DiscordRestClient methods', () => {
    describe('respondToInteraction', () => {
        ...
        test('throws and logs on API error', async () => {
            ...
            await expect(
                client.respondToInteraction('123', 'tok', { type: 4, data: {} }),
    ...
    describe('deferInteraction', () => {
        ...
        test('throws on API error', async () => {
            const { client } = createErrorClient();
            await expect(
                client.deferInteraction('456', 'tok'),
            ).rejects.toThrow('Discord API error');
        });
    });
    ...
    describe('editDeferredResponse', () => {
        ...
        test('throws on API error', async () => {
            const { client } = createErrorClient();
            await expect(
                client.editDeferredResponse('app-1', 'tok', {}),
            ).rejects.toThrow('Discord API error');
        });
    });
    ...
    describe('editMessage', () => {
        ...
        test('throws on API error', async () => {
            const { client } = createErrorClient();
            await expect(
                client.editMessage('chan-1', 'msg-1', {}),
            ).rejects.toThrow('Discord API error');
        });
    });
    ...
    describe('deleteMessage', () => {
        ...
        test('throws on API error', async () => {
            const { client } = createErrorClient();
            await expect(
                client.deleteMessage('chan-1', 'msg-1'),
            ).rejects.toThrow('Discord API error');
        });
    });
    ...
    describe('addReaction', () => {
        ...
        test('throws on API error', async () => {
            const { client } = createErrorClient();
            await expect(
                client.addReaction('chan-1', 'msg-1', '👍'),
            ).rejects.toThrow('Discord API error');
        });
    });
