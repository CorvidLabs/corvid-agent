...
describe('OutcomeTrackerService', () => {
  ...
  describe('recordPrFromWorkTask', () => {
    it('records a PR outcome from a work task', () => {
      const outcome = service.recordPrFromWorkTask('task-1', 'https://github.com/CorvidLabs/corvid-agent/pull/123');
    ...
    it('returns existing outcome if already recorded', () => {
      const first = service.recordPrFromWorkTask('task-1', 'https://github.com/CorvidLabs/corvid-agent/pull/123');
      const second = service.recordPrFromWorkTask('task-1', 'https://github.com/CorvidLabs/corvid-agent/pull/123');
