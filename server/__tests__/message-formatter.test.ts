...
import { collapseCodeBlocks, splitEmbedDescription, splitMessage } from '../discord/message-formatter';
...
describe('splitMessage', () => {
  ...
  test('splits at sentence boundaries when paragraphs are too long', () => {
    const text =
      'This is sentence one. This is sentence two. This is sentence three. This is the fourth and final sentence.';
