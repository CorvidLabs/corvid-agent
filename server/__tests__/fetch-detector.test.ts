...
import { extractDomain, formatScanReport, isDomainApproved, scanDiff } from '../lib/fetch-detector';
...
describe('extractDomain', () => {
  ...
  test('handles template literal URLs', () => {
    // biome-ignore lint/suspicious/noTemplateCurlyInString: intentional test of template literal URL detection
