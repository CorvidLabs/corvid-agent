...
import { setPersistedAppId, getPersistedAppId } from '../flock-directory/deploy';
...
describe('e2e: challenge creation and queries', () => {
    ...
    test('getChallengeInfo returns correct category and description', async () => {
        ...
        const challenge = await onChainClient.getChallengeInfo(
            CHALLENGE_RESPONSIVE,
            admin.address,
            admin.sk,
        );
