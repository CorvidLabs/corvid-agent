...
describe('generateRepoMap', () => {
  ...
  test('returns formatted map with exported symbols', async () => {
    ...
    files.set('/project/src/utils.ts', {
      ...
      symbols: [{ name: 'helper', kind: 'function', isExported: true, startLine: 1, endLine: 10 } as AstSymbol],
    } as unknown as FileSymbolIndex);
  ...
  test('sorts source dirs before test files', async () => {
    ...
    files.set('/project/test/foo.test.ts', {
      filePath: '/project/test/foo.test.ts',
      symbols: [sym],
    } as unknown as FileSymbolIndex);
      ...
      symbols: [
        {
          ...
          startLine: 1,
          endLine: 50,
          children: [{ name: 'doWork', kind: 'function', isExported: false, startLine: 5, endLine: 20 } as AstSymbol],
        } as AstSymbol,
      ],
    } as unknown as FileSymbolIndex);
