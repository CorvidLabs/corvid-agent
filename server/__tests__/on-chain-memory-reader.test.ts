...
function createMockContext(
  db: Database,
  memories: Array<{ key: string; content: string; txid: string; timestamp: string; confirmedRound: number }> = [],
): McpToolContext {
  return {
    agentId: 'agent-1',
    db,
    ...
    const memories = [
      {
        ...
        txid: 'ABCDEF123456789012345678901234567890123456789012',
        timestamp: '2026-03-17T10:00:00.000Z',
        confirmedRound: 100,
      },
      {
        key: 'project-status',
        content: 'v1.0 in progress',
        txid: 'ZYXWVU987654321098765432109876543210987654321098',
