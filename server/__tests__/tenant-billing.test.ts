...
import { TENANT_SCOPED_TABLES, validateTenantOwnership, withTenantFilter } from '../tenant/db-filter';
...
describe('BillingService', () => {
  ...
  test('createInvoice stores invoice', () => {
    const invoice = billing.createInvoice('tenant-1', 'inv_abc', 5000, '2026-02-01', '2026-03-01');
