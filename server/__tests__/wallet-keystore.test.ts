...
import { chmodSync, existsSync, mkdtempSync, statSync, unlinkSync, writeFileSync } from 'node:fs';
...
const { readKeystore, getKeystoreEntry, saveKeystoreEntry, removeKeystoreEntry, getKeystorePath } = await import(
  '../lib/wallet-keystore'
);
