...
const { encryptMnemonic, decryptMnemonic, encryptMemoryContent, decryptMemoryContent, getEncryptionPassphrase } =
  _crypto as typeof import('../lib/crypto');
...
describe('getEncryptionPassphrase', () => {
  ...
  it('throws on mainnet even with server mnemonic', () => {
    expect(() => getEncryptionPassphrase('mainnet', 'my-server-mnemonic')).toThrow(
