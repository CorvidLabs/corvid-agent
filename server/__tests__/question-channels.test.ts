...
describe('sendAlgoChatQuestion', () => {
  ...
  test('formats message with QUESTION tag and short ID', async () => {
    ...
    await sendAlgoChatQuestion(messenger, 'ADDR', TEST_QUESTION_ID, TEST_QUESTION, null, TEST_AGENT_ID);
  ...
  test('includes numbered options when provided', async () => {
    ...
    await sendAlgoChatQuestion(messenger, 'ADDR', TEST_QUESTION_ID, TEST_QUESTION, TEST_OPTIONS, TEST_AGENT_ID);
  ...
  test('omits options section when options is empty', async () => {
    ...
    await sendAlgoChatQuestion(messenger, 'ADDR', TEST_QUESTION_ID, TEST_QUESTION, [], TEST_AGENT_ID);
  ...
  test('passes correct agentId and toAddress to messenger', async () => {
    ...
    await sendAlgoChatQuestion(messenger, 'RECIPIENT_ADDR', TEST_QUESTION_ID, TEST_QUESTION, null, TEST_AGENT_ID);
...
describe('sendGitHubQuestion', () => {
  test('returns success with externalRef when createIssue succeeds', async () => {
    ...
    const result = await fn('owner/repo', TEST_QUESTION_ID, TEST_QUESTION, TEST_OPTIONS, TEST_CONTEXT, TEST_AGENT_ID);
  ...
  test('returns success: false when createIssue returns ok: false', async () => {
    const mockCreateIssue = mock(() => Promise.resolve({ ok: false, error: 'Not Found' }));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));

    const { sendGitHubQuestion: fn } = await import('../notifications/channels/github-question');
    const result = await fn('owner/nonexistent', TEST_QUESTION_ID, TEST_QUESTION, null, null, TEST_AGENT_ID);
  ...
  test('returns success: false when createIssue throws', async () => {
    const mockCreateIssue = mock(() => Promise.reject(new Error('Network error')));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));
  ...
  test('truncates long question in issue title to 60 chars with ellipsis', async () => {
    ...
    const mockCreateIssue = mock(() => Promise.resolve({ ok: true, issueUrl: 'https://github.com/o/r/issues/1' }));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));
  ...
  test('does not add ellipsis when question fits in 60 chars', async () => {
    ...
    const mockCreateIssue = mock(() => Promise.resolve({ ok: true, issueUrl: 'https://github.com/o/r/issues/2' }));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));
  ...
  test('includes context section in body when context is provided', async () => {
    const mockCreateIssue = mock(() => Promise.resolve({ ok: true, issueUrl: 'https://github.com/o/r/issues/3' }));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));
  ...
  test('omits context section when context is null', async () => {
    const mockCreateIssue = mock(() => Promise.resolve({ ok: true, issueUrl: 'https://github.com/o/r/issues/4' }));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));
  ...
  test('includes checkbox-style options in body', async () => {
    const mockCreateIssue = mock(() => Promise.resolve({ ok: true, issueUrl: 'https://github.com/o/r/issues/5' }));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));
  ...
  test('passes correct labels', async () => {
    const mockCreateIssue = mock(() => Promise.resolve({ ok: true, issueUrl: 'https://github.com/o/r/issues/6' }));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));
  ...
  test('includes agent and question metadata in body', async () => {
    const mockCreateIssue = mock(() => Promise.resolve({ ok: true, issueUrl: 'https://github.com/o/r/issues/7' }));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));
  ...
  test('returns generic error when createIssue returns ok: false with no error', async () => {
    const mockCreateIssue = mock(() => Promise.resolve({ ok: false }));
    mock.module('../github/operations', () => ({
      createIssue: mockCreateIssue,
    }));
...
describe('sendSlackQuestion', () => {
  ...
  test('sends correct authorization header', async () => {
    ...
    const { sendSlackQuestion } = await import('../notifications/channels/slack-question');
    await sendSlackQuestion('xoxb-my-token', '#general', TEST_QUESTION_ID, TEST_QUESTION, null, null, TEST_AGENT_ID);
  ...
  test('creates action buttons for options', async () => {
    ...
    const { sendSlackQuestion } = await import('../notifications/channels/slack-question');
    await sendSlackQuestion('xoxb-token', '#ch', TEST_QUESTION_ID, TEST_QUESTION, TEST_OPTIONS, null, TEST_AGENT_ID);
  ...
  test('omits actions block when options is null', async () => {
    ...
    const { sendSlackQuestion } = await import('../notifications/channels/slack-question');
    await sendSlackQuestion('xoxb-token', '#ch', TEST_QUESTION_ID, TEST_QUESTION, null, null, TEST_AGENT_ID);
  ...
  test('includes question context in section block when provided', async () => {
    ...
    const { sendSlackQuestion } = await import('../notifications/channels/slack-question');
    await sendSlackQuestion('xoxb-token', '#ch', TEST_QUESTION_ID, TEST_QUESTION, null, TEST_CONTEXT, TEST_AGENT_ID);
  ...
  test('truncates option text to 75 chars', async () => {
    ...
    const { sendSlackQuestion } = await import('../notifications/channels/slack-question');
    await sendSlackQuestion('xoxb-token', '#ch', TEST_QUESTION_ID, TEST_QUESTION, [longOption], null, TEST_AGENT_ID);
...
describe('sendTelegramQuestion', () => {
  ...
  test('returns success with externalRef when Telegram API returns ok', async () => {
    globalThis.fetch = mock(() =>
      Promise.resolve(new Response(JSON.stringify({ ok: true, result: { message_id: 12345 } }), { status: 200 })),
    ) as unknown as typeof fetch;
  ...
  test('returns success: false when Telegram API returns ok: false', async () => {
    globalThis.fetch = mock(() =>
      Promise.resolve(new Response(JSON.stringify({ ok: false, description: 'Unauthorized' }), { status: 401 })),
    ) as unknown as typeof fetch;
  ...
  test('sends request to correct Telegram API URL', async () => {
    ...
    const { sendTelegramQuestion } = await import('../notifications/channels/telegram-question');
    await sendTelegramQuestion('bot123:SECRET', '999888', TEST_QUESTION_ID, TEST_QUESTION, null, null, TEST_AGENT_ID);
  ...
  test('sends correct chat_id and parse_mode', async () => {
    ...
    const { sendTelegramQuestion } = await import('../notifications/channels/telegram-question');
    await sendTelegramQuestion('bot123:TOKEN', '999888', TEST_QUESTION_ID, TEST_QUESTION, null, null, TEST_AGENT_ID);
  ...
  test('omits reply_markup when options is null', async () => {
    ...
    const { sendTelegramQuestion } = await import('../notifications/channels/telegram-question');
    await sendTelegramQuestion('bot123:TOKEN', '999', TEST_QUESTION_ID, TEST_QUESTION, null, null, TEST_AGENT_ID);
  ...
  test('handles non-Error throw gracefully', async () => {
    globalThis.fetch = mock(() => Promise.reject('raw-string-error')) as unknown as typeof fetch;
