...
describe('Billing Routes', () => {
  ...
  it('POST /api/billing/subscription creates with stripeItems', async () => {
    ...
    const items = db.query('SELECT * FROM subscription_items WHERE stripe_item_id = ?').all('si_metered_001') as Array<{
  ...
  it('reportAll() skips records without subscription items', async () => {
    ...
    billing.createSubscription(noItemTenantId, 'sub_noitem_123', 'pro', '2026-03-01T00:00:00Z', '2026-04-01T00:00:00Z');
