...
import { handleAgentPersonaCommand, handleAgentSkillCommand } from '../discord/command-handlers/agent-config-commands';
...
describe('handleAgentSkillCommand', () => {
  test('rejects non-admin permission level', async () => {
    ...
    const interaction = makeSubcommandInteraction('agent-skill', 'list', [{ name: 'agent', value: agent.name }]);
  ...
  test('list returns "no bundles" embed when none assigned', async () => {
    ...
    const interaction = makeSubcommandInteraction('agent-skill', 'list', [{ name: 'agent', value: 'TestBot' }]);
  ...
  test('reports error when agent not found', async () => {
    ...
    const interaction = makeSubcommandInteraction('agent-skill', 'list', [{ name: 'agent', value: 'NonExistentBot' }]);
  ...
  test('list shows all assigned bundles', async () => {
    ...
    capturedResponse = null;
    const listInteraction = makeSubcommandInteraction('agent-skill', 'list', [{ name: 'agent', value: 'TestBot' }]);
...
describe('handleAgentPersonaCommand', () => {
  test('rejects non-admin permission level', async () => {
    const ctx = createTestContext();
    createAgent(db, { name: 'TestBot', model: 'test-model' });
    const interaction = makeSubcommandInteraction('agent-persona', 'list', [{ name: 'agent', value: 'TestBot' }]);
