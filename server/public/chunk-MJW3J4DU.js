import { L as E, c as Et, a as fe, O as Tt } from './chunk-LF4EWAJA.js';
import { f as Fe, j as me, k as ne, a as S, e as vt, i as Y, b as z } from './chunk-UXY6QH5L.js';
...
function le(n, e, t) {
  return Object.hasOwn(n, 'duration') ? n : zs(n, e, t);
}
...
function te(n, e, t) {
  const s = `${n}`,
    i = s.replace(Ke, (_r, a) => {
      let o = e[a];
      return o == null && (t.push(Ps(a)), (o = '')), o.toString();
    });
  return i === s ? n : i;
}
var Ks = /-+([a-z0-9])/g;
...
var gs = (() => {
    class n {
      ...
      computeStyle(_t, _s, i) {
        return i || '';
      }
      animate(_t, _s, i, r, _a, _o = [], _l) {
        return new Y(i, r);
      }
      static \u0275fac = (s) => new (s || n)();
      static \u0275prov = Tt({ token: n, factory: n.\u0275fac });
    }
    return n;
  })(),
  is = class {
  ...
  Ze = class {},
  xe = class {
    normalizePropertyName(e, _t) {
      return e;
    }
    normalizeStyleValue(_e, _t, s, _i) {
      return s;
    }
  },
  Bs = new Set([
...
var rs = '',
  tt = class {
    ...
    build(e, t, _s) {
      const i = new st(t);
      return this._resetContextStyleTimingState(i), O(this, ee(e), i);
    }
      ...
      return (
        ...
        e.definitions.forEach((o) => {
          if ((this._resetContextStyleTimingState(t), o.type === S.State)) {
            ...
            const l = this.visitTransition(o, t);
    ...
    visitState(e, t) {
      ...
      if (s.containsDynamicStyles) {
        ...
        s.styles.forEach((o) => {
          ...
          r.size && t.errors.push(Mt(e.name, [...r.values()]));
      }
      return { type: S.State, name: e.name, style: s, options: i ? { params: i } : null };
    }
    visitTransition(e, t) {
      (t.queryCount = 0), (t.depCount = 0);
      const s = O(this, ee(e.animation), t),
    ...
    visitSequence(e, t) {
      return { type: S.Sequence, steps: e.steps.map((s) => O(this, s, t)), options: J(e.options) };
    }
    visitGroup(e, t) {
      let s = t.currentTime,
        i = 0,
      ...
      return (t.currentTime = i), { type: S.Group, steps: r, options: J(e.options) };
    }
    visitAnimate(e, t) {
      const s = Hs(e.timings, t.errors);
      t.currentAnimateTimings = s;
      let i,
        r = e.styles ? e.styles : Fe({});
    ...
    _makeStyleAst(e, t) {
      ...
      for (const o of i)
        typeof o === 'string' ? (o === z ? s.push(o) : t.errors.push(Ct(o))) : s.push(new Map(Object.entries(o)));
      let r = !1,
        a = null;
      return (
        s.forEach((o) => {
            ...
            a.forEach((o, l) => {
              ...
              h &&
                (r !== i &&
                  r >= h.startTime &&
                  i <= h.endTime &&
                  (t.errors.push(kt(l, h.startTime, h.endTime, r, i)), (c = !1)),
                (r = h.startTime)),
    ...
    visitKeyframes(e, t) {
      const s = { type: S.Keyframes, styles: [], options: null };
      if (!t.currentAnimateTimings) return t.errors.push(Dt()), s;
      let i = 1,
        r = 0,
        a = [],
        o = !1,
        ...
        h = e.steps.map((w) => {
          let A = this._makeStyleAst(w, t),
            C = A.offset != null ? A.offset : Ws(A.styles),
            N = 0;
          return (
            C != null && (r++, (N = A.offset = C)), (l = l || N < 0 || N > 1), (o = o || N < u), (u = N), a.push(N), A
          );
        });
      l && t.errors.push(Rt()), o && t.errors.push(Ot());
      let c = e.steps.length,
        _ = 0;
      r > 0 && r < c ? t.errors.push(Lt()) : r === 0 && (_ = i / (c - 1));
      const y = c - 1,
        f = t.currentTime,
      ...
      return (
        h.forEach((w, A) => {
          const C = _ > 0 ? (A === y ? 1 : _ * A) : a[A],
            N = C * v;
          (t.currentTime = f + g.delay + N),
            (g.duration = N),
    ...
    visitReference(e, t) {
      return { type: S.Reference, animation: O(this, ee(e.animation), t), options: J(e.options) };
    }
    visitAnimateChild(e, t) {
      return t.depCount++, { type: S.AnimateChild, options: J(e.options) };
    }
    visitAnimateRef(e, t) {
      return { type: S.AnimateRef, animation: this.visitReference(e.animation, t), options: J(e.options) };
    }
    visitQuery(e, t) {
      const s = t.currentQuerySelector,
        i = e.options || {};
      t.queryCount++, (t.currentQuery = e);
      const [r, a] = Gs(e.selector);
      (t.currentQuerySelector = s.length ? `${s} ${r}` : r), R(t.collectedStyles, t.currentQuerySelector, new Map());
      const o = O(this, ee(e.animation), t);
      return (
        (t.currentQuery = null),
    ...
    visitStagger(e, t) {
      t.currentQuery || t.errors.push(Ft());
      const s = e.timings === 'full' ? { duration: 0, delay: 0, easing: 'full' } : le(e.timings, t.errors, !0);
      return { type: S.Stagger, animation: O(this, ee(e.animation), t), timings: s, options: null };
    }
  };
function Gs(n) {
  const e = !!n.split(/\s*,\s*/).find((t) => t === ys);
  return (
    e && (n = n.replace(Us, '')),
    (n = n
      .replace(/@\*/g, oe)
...
function Hs(n, e) {
  if (Object.hasOwn(n, 'duration')) return n;
  if (typeof n === 'number') {
    const r = le(n, e).duration;
    return We(r, 0, '');
  }
  const t = n;
...
function J(n) {
  return n ? ((n = fe({}, n)), n.params && (n.params = js(n.params))) : (n = {}), n;
}
function We(n, e, t) {
...
var it = class {
    buildKeyframes(e, t, s, i, r, a, o, l, u, h = []) {
      u = u || new ie();
      const c = new nt(e, t, u, i, r, h, []);
      c.options = l;
      const _ = l.delay ? V(l.delay) : 0;
      c.currentTimeline.delayNextStep(_), c.currentTimeline.setStyles([a], null, c.errors, l), O(this, s, c);
      const y = c.timelines.filter((f) => f.containsAnimation());
      if (y.length && o.size) {
        let f;
    ...
    _applyAnimationRefDelays(e, t, s) {
      for (const i of e) {
        const r = i?.delay;
        if (r) {
          const a = typeof r === 'number' ? r : V(te(r, i?.params ?? {}, t.errors));
          s.delayNextStep(a);
        }
      }
    }
    _visitSubInstructions(e, t, s) {
      ...
      return (
        a !== 0 &&
          e.forEach((l) => {
            const u = t.appendInstructionToTimeline(l, a, o);
    ...
    visitGroup(e, t) {
      let s = [],
        ...
        r = e.options?.delay ? V(e.options.delay) : 0;
      e.steps.forEach((a) => {
    ...
    _visitTiming(e, t) {
      if (e.dynamic) {
        const s = e.strValue,
          i = t.params ? te(s, t.params, t.errors) : s;
    ...
    visitQuery(e, t) {
      ...
      r &&
        (t.previousNode.type === S.Style || (s === 0 && t.currentTimeline.hasCurrentStyleProperties())) &&
    ...
    visitStagger(e, t) {
      ...
      const h = t.currentTimeline;
      l && h.delayNextStep(l);
      const c = h.currentTime;
  ...
  nt = class n {
    ...
    constructor(e, t, s, i, r, a, o, l) {
      (this._driver = e),
        ...
        (this.errors = a),
        (this.timelines = o),
        (this.currentTimeline = l || new Me(this._driver, t, 0)),
      ...
      if (r) {
        ...
        a || (a = this.options.params = {}),
          Object.keys(r).forEach((o) => {
            (!t || !Object.hasOwn(a, o)) && (a[o] = te(r[o], a, this.errors));
          });
      }
    }
    _copyOptions() {
    ...
    appendInstructionToTimeline(e, t, s) {
      const i = { duration: t ?? e.duration, delay: this.currentTimeline.currentTime + (s ?? 0) + e.delay, easing: '' },
        r = new rt(
          this._driver,
          e.element,
          e.keyframes,
  ...
  Me = class n {
    ...
    fork(e, t) {
      return (
        this.applyStylesToKeyframe(), new n(this._driver, e, t || this.currentTime, this._elementTimelineStylesLookup)
      );
    }
    _loadKeyframe() {
    ...
    applyEmptyStep(e) {
      ...
      for (const [t, s] of this._globalTimelineStyles) this._backFill.set(t, s || z), this._currentKeyframe.set(t, z);
    ...
    snapshotCurrentStyles() {
      for (const [e, t] of this._localTimelineStyles) this._pendingStyles.set(e, t), this._updateStyle(e, t);
    }
    getFinalKeyframe() {
    ...
    get properties() {
      const e = [];
      for (const t in this._currentKeyframe) e.push(t);
      return e;
    }
...
function ei(n, e) {
  ...
  return (
    n.forEach((i) => {
      if (i === '*') {
        s ??= e.keys();
        for (const r of s) t.set(r, z);
      } else for (const [r, a] of i) t.set(r, a);
    }),
    t
  );
}
function os(n, e, t, s, i, r, a, o, l, u, h, c, _) {
  return {
    type: 0,
    element: n,
    triggerName: e,
...
var He = {},
  Ce = class {
    ...
    build(e, t, s, i, r, a, o, l, u, h) {
      let c = [],
        _ = this.ast.options?.params || He,
        y = o?.params || He,
        f = this.buildStyles(s, y, c),
        g = l?.params || He,
        v = this.buildStyles(i, g, c),
        w = new Set(),
        A = new Map(),
        C = new Map(),
        N = i === 'void',
        Z = { params: _s(g, _), delay: this.ast.options?.delay },
        B = h ? [] : pt(e, t, this.ast.animation, r, a, f, v, Z, u, c),
        k = 0;
      return (
        B.forEach((D) => {
        ...
        c.length
          ? os(t, this._triggerName, s, i, N, f, v, [], [], A, C, k, c)
          : (B.forEach((D) => {
              const j = D.element,
                x = R(A, j, new Set());
              D.preStyleProps.forEach((W) => x.add(W));
              const gt = R(C, j, new Set());
              D.postStyleProps.forEach((W) => gt.add(W)), j !== t && w.add(j);
            }),
            os(t, this._triggerName, s, i, N, f, v, B, [...w.values()], A, C, k))
      );
    }
  };
    ...
    return (
      this.styles.styles.forEach((r) => {
        typeof r !== 'string' &&
          r.forEach((a, o) => {
            a && (a = te(a, i, t));
            const l = this.normalizer.normalizePropertyName(o, t);
...
function ii(n, e, _t) {
  const s = [(_a, _o) => !0],
    ...
    r = { type: S.Transition, animation: i, matchers: s, options: null, queryCount: 0, depCount: 0 };
  return new Ce(n, r, e);
}
function ls(n, e, t) {
...
var ni = new ie(),
  lt = class {
    ...
    create(e, t, s = {}) {
      ...
      if (
        (r
          ? ((a = pt(this._driver, t, r, _e, re, new Map(), new Map(), s, ni, i)),
            a.forEach((h) => {
              const c = R(o, h.element, new Map());
  ...
  Ye = 'ng-animate-disabled',
  ai = '.ng-animate-disabled',
  oi = 'ng-star-inserted',
  li = '.ng-star-inserted',
  ui = [],
  Ss = { namespaceId: '', setForRemoval: !1, setForMove: !1, hasAnimation: !1, removedBeforeQueried: !1 },
  ci = { namespaceId: '', setForMove: !1, setForRemoval: !1, hasAnimation: !1, removedBeforeQueried: !0 },
  q = '__ng_removed',
  ce = class {
    namespaceId;
    value;
    ...
    constructor(e, t = '') {
      this.namespaceId = t;
      const s = e && Object.hasOwn(e, 'value'),
        i = s ? e.value : e;
      if (((this.value = di(i)), s)) {
        const r = e,
          { value: a } = r,
          o = Et(r, ['value']);
        this.options = o;
  ...
  ut = class {
    ...
    listen(e, t, s, i) {
      if (!this._triggers.has(t)) throw jt(s, t);
      if (s == null || s.length === 0) throw Wt(t);
      if (!fi(s)) throw Ht(s, t);
      const r = R(this._elementListeners, e, []),
        a = { name: t, phase: s, callback: i };
      r.push(a);
      const o = R(this._engine.statesByElement, e, new Map());
      return (
        o.has(t) || (I(e, ae), I(e, `${ae}-${t}`), o.set(t, Xe)),
        () => {
    ...
    trigger(e, t, s, i = !0) {
      ...
      const _ = R(this._engine.playersByElement, e, []);
      _.forEach((g) => {
      ...
      return (
        ...
        a.onDone(() => {
          const g = this.players.indexOf(a);
          g >= 0 && this.players.splice(g, 1);
          const v = this._engine.playersByElement.get(e);
          if (v) {
            const w = v.indexOf(a);
            w >= 0 && v.splice(w, 1);
          }
    ...
    _signalRemovalForInnerTriggers(e, t) {
      const s = this._engine.driver.query(e, oe, !0);
      s.forEach((i) => {
        if (i[q]) return;
      ...
      if (r) {
        ...
        if (
          ...
          return (
            ...
            s && $(o).onDone(() => this._engine.processLeaveNode(e)),
            !0
          );
      }
      return !1;
    ...
    drainQueuedTransitions(e) {
      ...
      return (
        this._queue.forEach((s) => {
          ...
          a?.forEach((o) => {
            if (o.name === s.triggerName) {
              const l = ge(r, s.triggerName, s.fromState.value, s.toState.value);
        ...
        (this._queue = []),
        t.sort((s, i) => {
          const r = s.transition.ast.depCount,
  ...
  ct = class {
    ...
    registerTrigger(e, t, s) {
      const i = this._namespaceLookup[e];
      i?.register(t, s) && this.totalAnimations++;
    }
    destroy(e, t) {
      e &&
        (this.afterFlush(() => {}),
    ...
    markElementAsDisabled(e, t) {
      t
        ...
        : this.disabledNodes.has(e) && (this.disabledNodes.delete(e), se(e, Ye));
    }
    removeNode(e, t, s) {
      if (we(t)) {
    ...
    finishActiveQueriedAnimationOnElement(e) {
      ...
      t?.forEach((s) => s.finish());
    }
    whenRenderingDone() {
      return new Promise((e) => {
        if (this.players.length) return $(this.players).onDone(() => e());
        e();
      });
    }
    processLeaveNode(e) {
    ...
    _flushAnimations(e, t) {
      ...
      this.disabledNodes.forEach((d) => {
        h.add(d);
        const m = this.driver.query(d, ri, !0);
        for (let p = 0; p < m.length; p++) h.add(m[p]);
      });
      let c = this.bodyNode,
        _ = Array.from(this.statesByElement.keys()),
        y = ds(_, this.collectedEnterElements),
        f = new Map(),
        g = 0;
      y.forEach((d, m) => {
        const p = _e + g++;
        f.set(m, p), d.forEach((T) => I(T, p));
      });
      const v = [],
        w = new Set(),
        A = new Set();
      ...
      for (let d = this._namespaceList.length - 1; d >= 0; d--)
        this._namespaceList[d].drainQueuedTransitions(t).forEach((p) => {
          ...
          if ((Z.push(T), this.collectedEnterElements.length)) {
            const M = P[q];
            if (M?.setForMove) {
              if (M.previousTriggersValues?.has(p.triggerName)) {
                const H = M.previousTriggersValues.get(p.triggerName),
                  F = this.statesByElement.get(p.element);
                if (F?.has(p.triggerName)) {
                  const de = F.get(p.triggerName);
          ...
          const Q = !c || !this.driver.containsElement(c, P),
            L = C.get(P),
            U = f.get(P),
            b = this._buildInstruction(p, s, U, L, Q);
          if (b.errors?.length) {
            B.push(b);
            return;
          }
          ...
          const St = [];
          b.timelines.forEach((M) => {
            (M.stretchStartingKeyframe = !0), this.disabledNodes.has(M.element) || St.push(M);
          }),
            (b.timelines = St),
            s.append(P, b.timelines);
          const vs = { instruction: b, player: T, element: P };
          a.push(vs),
            b.queriedElements.forEach((M) => R(o, M, []).push(T)),
            b.preStyleProps.forEach((M, H) => {
              if (M.size) {
                let F = l.get(H);
                F || l.set(H, (F = new Set())), M.forEach((_de, Le) => F.add(Le));
              }
            }),
            b.postStyleProps.forEach((M, H) => {
              let F = u.get(H);
              F || u.set(H, (F = new Set())), M.forEach((_de, Le) => F.add(Le));
            });
        });
      if (B.length) {
        const d = [];
        B.forEach((m) => {
          d.push(Jt(m.triggerName, m.errors));
        }),
      ...
      a.forEach((d) => {
        const m = d.element;
        s.has(m) && (D.set(m, m), this._beforeAnimationBuild(d.player.namespaceId, d.instruction, k));
      }),
        i.forEach((d) => {
          const m = d.element;
          this._getPreviousPlayers(m, !1, d.namespaceId, d.triggerName, null).forEach((T) => {
            R(k, m, []).push(T), T.destroy();
          });
        });
      const j = v.filter((d) => fs(d, l, u)),
        x = new Map();
      hs(x, this.driver, A, u, z).forEach((d) => {
        fs(d, l, u) && j.push(d);
      });
      const W = new Map();
      y.forEach((d, _m) => {
        hs(W, this.driver, new Set(d), l, ne);
      }),
        j.forEach((d) => {
          const m = x.get(d),
            p = W.get(d);
          x.set(d, new Map([...(m?.entries() ?? []), ...(p?.entries() ?? [])]));
        });
      const Oe = [],
        yt = [],
        _t = {};
      a.forEach((d) => {
        const { element: m, player: p, instruction: T } = d;
        if (s.has(m)) {
          if (h.has(m)) {
          ...
          const Q = this._buildAnimation(p.namespaceId, T, k, r, W, x);
          if ((p.setRealPlayer(Q), P === _t)) Oe.push(p);
          else {
            const L = this.playersByElement.get(P);
            L?.length && (p.parentPlayer = $(L)), i.push(p);
          }
        } else G(m, T.fromStyles), p.onDestroy(() => K(m, T.toStyles)), yt.push(p), h.has(m) && i.push(p);
      }),
        yt.forEach((d) => {
          const m = r.get(d.element);
          if (m?.length) {
            const p = $(m);
            d.setRealPlayer(p);
          }
      ...
      for (let d = 0; d < v.length; d++) {
        const m = v[d],
          p = m[q];
        if ((se(m, re), p?.hasAnimation)) continue;
        const T = [];
        if (o.size) {
          const Q = o.get(m);
          Q?.length && T.push(...Q);
          const L = this.driver.query(m, Se, !0);
          for (let U = 0; U < L.length; U++) {
            const b = o.get(L[U]);
            b?.length && T.push(...b);
          }
        }
        const P = T.filter((Q) => !Q.destroyed);
    ...
    _beforeAnimationBuild(e, t, s) {
      ...
      for (const l of t.timelines) {
        ...
        this._getPreviousPlayers(u, h, a, o, t.toState).forEach((y) => {
          const f = y.getRealPlayer();
          f.beforeDestroy?.(), y.destroy(), c.push(y);
        });
      }
      G(r, t.fromStyles);
    }
    _buildAnimation(e, t, s, i, r, a) {
      const o = t.triggerName,
        ...
        _ = t.timelines.map((f) => {
          ...
          h.add(g);
          const v = g[q];
          if (v?.removedBeforeQueried) return new Y(f.duration, f.delay);
          const w = g !== l,
            A = pi((s.get(g) || ui).map((k) => k.getRealPlayer())).filter((k) => {
              const D = k;
              return D.element ? D.element === g : !1;
            }),
            C = r.get(g),
            N = a.get(g),
            Z = qe(this._normalizer, f.keyframes, C, N),
            B = this._buildPlayer(f, Z, A);
          if ((f.subTimeline && i && c.add(g), w)) {
            const k = new he(e, o, g);
            k.setRealPlayer(B), u.push(k);
          }
          return B;
        });
      u.forEach((f) => {
        R(this.playersByQueriedElement, f.element, []).push(f),
          f.onDone(() => hi(this.playersByQueriedElement, f.element, f));
      }),
        h.forEach((f) => I(f, Ue));
      const y = $(_);
      return (
        y.onDestroy(() => {
          h.forEach((f) => se(f, Ue)), K(l, t.toStyles);
        }),
        c.forEach((f) => {
          R(i, f, []).push(y);
        }),
...
function hs(n, e, t, s, i) {
  const r = [];
  t.forEach((l) => r.push(cs(l)));
  const a = [];
  s.forEach((l, u) => {
    const h = new Map();
    l.forEach((c) => {
      const _ = e.computeStyle(u, c, i);
      h.set(c, _), (!_ || _.length === 0) && ((u[q] = ci), a.push(u));
    }),
      n.set(u, h);
  });
  let o = 0;
  return t.forEach((l) => cs(l, r[o++])), a;
}
function ds(n, e) {
  const t = new Map();
...
function yi(n, e) {
  ...
  return (
    Array.isArray(e) && e.length
      ? ((t = Je(e[0])), e.length > 1 && (s = Je(e[e.length - 1])))
      : e instanceof Map && (t = Je(e)),
...
var De = class {
    ...
    finish() {
      this.init(), this.domPlayer && (this._specialStyles?.finish(), this._onFinish(), this.domPlayer.finish());
    }
    reset() {
  ...
  ht = class {
    validateStyleProperty(_e) {
      return !0;
    }
    validateAnimatableStyleProperty(_e) {
      return !0;
    }
    containsElement(e, t) {
      return Qe(e, t);
    ...
    animate(e, t, s, i, r, a = []) {
      const o = i === 0 ? 'both' : 'forwards',
        l = { duration: s, delay: i, fill: o };
      r && (l.easing = r);
      const u = new Map(),
        h = a.filter((y) => y instanceof De);
      ts(s, i) &&
        h.forEach((y) => {
          y.currentSnapshot.forEach((f, g) => u.set(g, f));
        });
      let c = xt(t).map((y) => new Map(y));
      c = ss(e, c, u);
      const _ = yi(e, c);
      return new De(e, c, l, _);
    }
  };
function Mi(n, e) {
  return n === 'noop' ? new ke(e, new gs(), new xe()) : new ke(e, new ht(), new et());
}
var ms = class {
    _driver;
    _animationAst;
    ...
    buildTimelines(e, t, s, i, r) {
      const a = Array.isArray(t) ? Ge(t) : t,
        o = Array.isArray(s) ? Ge(s) : s,
        l = [];
      r = r || new ie();
      const u = pt(this._driver, e, this._animationAst, _e, re, a, o, i, r, l);
...
var ps = class {
  ...
  begin() {
    this._cdRecurDepth++, this.delegate.begin?.();
  }
  _scheduleCountTask() {
    queueMicrotask(() => {
      this._microtaskId++;
...
export {
  ...
  De as \u0275WebAnimationsPlayer,
  dt as \u0275AnimationRenderer,
  et as \u0275WebAnimationsStyleNormalizer,
  gs as NoopAnimationDriver,
  he as \u0275TransitionAnimationPlayer,
  ht as \u0275WebAnimationsDriver,
  is as AnimationDriver,
  ke as \u0275AnimationEngine,
  Mi as \u0275createEngine,
  ms as \u0275Animation,
  ps as \u0275AnimationRendererFactory,
  Qe as \u0275containsElement,
  qs as \u0275camelCaseToDashCase,
  Re as \u0275BaseAnimationRenderer,
  Rs as \u0275validateWebAnimatableStyleProperty,
  re as \u0275LEAVE_CLASSNAME,
  ts as \u0275allowPreviousPlayerStylesMerge,
  Ve as \u0275invokeQuery,
  xe as \u0275NoopAnimationStyleNormalizer,
  xt as \u0275normalizeKeyframes,
  ye as \u0275getParentElement,
  Ze as \u0275AnimationStyleNormalizer,
  Zt as \u0275validateStyleProperty,
};
