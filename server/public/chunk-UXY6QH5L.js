var r = ((s) => (
  ...
  _ = '*';
function a(s, t) {
  return { type: r.Trigger, name: s, definitions: t, options: {} };
}
function c(s, t = null) {
  return { type: r.Animate, styles: t, timings: s };
}
function y(s, t = null) {
  return { type: r.Sequence, steps: s, options: t };
}
function F(s) {
  return { type: r.Style, styles: s, offset: null };
}
function S(s, t, e = null) {
  return { type: r.Transition, expr: s, animation: t, options: e };
}
function g(s, t, e = null) {
  return { type: r.Query, selector: s, animation: t, options: e };
}
var l = class {
    _onDoneFns = [];
    _onStartFns = [];
    ...
    triggerCallback(t) {
      const e = t === 'start' ? this._onStartFns : this._onDoneFns;
  ...
  u = class {
    ...
    constructor(t) {
      ...
      h === 0
        ...
        (this.totalTime = this.players.reduce((i, f) => Math.max(i, f.totalTime), 0));
    }
    _onFinish() {
      this._finished || ((this._finished = !0), this._onDoneFns.forEach((t) => t()), (this._onDoneFns = []));
    }
    ...
    setPosition(t) {
      ...
      this.players.forEach((n) => {
        const o = n.totalTime ? Math.min(1, e / n.totalTime) : 1;
        n.setPosition(o);
      });
    }
    getPosition() {
      const t = this.players.reduce((e, n) => (e === null || n.totalTime > e.totalTime ? n : e), null);
...
export { _ as b, a as c, c as d, D as k, F as f, g as h, l as i, r as a, S as g, u as j, y as e };
