...
import type { AgentSchedule, ScheduleAction, ScheduleActionType, ScheduleExecution } from '../../shared/types';
import { recordAudit } from '../db/audit';
import { acquireRepoLock, releaseAllLocks } from '../db/repo-locks';
import { getExecution, updateExecutionStatus } from '../db/schedules';
...
export function handleApprovalIfNeeded(
  ...
  if (notificationService) {
    ...
    notificationService
      ...
      .catch((err) =>
        log.warn('Approval notification failed', {
          scheduleId: schedule.id,
