...
import { z } from 'zod';
import { type HttpMethod, routes } from './route-registry';
...
export function generateOpenApiSpec(options: GeneratorOptions = {}): OpenApiSpec {
  ...
  return {
    ...
    info: {
      ...
      version: APP_VERSION,
      description:
        'AI agent framework with on-chain identity and messaging via AlgoChat on Algorand. Provides multi-agent orchestration, GitHub automation, workflow pipelines, and an agent marketplace.',
      license: {
        name: 'MIT',
