...
export const billingRoutes: RouteEntry[] = [
  ...
  {
    method: 'POST',
    path: '/api/billing/subscription/{tenantId}/cancel',
    ...
    responses: {
      200: {
        ...
        example: { success: true, status: 'cancelled', effectiveAt: '2026-04-01T00:00:00.000Z' },
      },
    },
  },
  {
    method: 'GET',
    path: '/api/billing/usage/{tenantId}',
