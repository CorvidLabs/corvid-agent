...
export const sandboxRoutes: RouteEntry[] = [
  ...
  },
  {
    ...
    responses: {
      200: {
        ...
        example: {
          policies: [{ agentId: 'agent_a1b2c3d4', enabled: true, memoryMb: 512, cpuShares: 512 }],
        },
      },
    },
  },
  {
    method: 'GET',
    path: '/api/sandbox/policies/{agentId}',
  ...
  {
    method: 'POST',
    path: '/api/sandbox/release/{sessionId}',
