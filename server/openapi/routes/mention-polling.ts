...
export const mentionPollingRoutes: RouteEntry[] = [
  ...
  {
    method: 'GET',
    path: '/api/mention-polling/stats',
  ...
  },
  {
    ...
    responses: {
      200: {
        description: 'Updated polling config',
        example: { ...POLLING_CONFIG_EXAMPLE, pollIntervalMinutes: 10, enabled: false },
      },
    },
  },
  {
  ...
  {
    method: 'GET',
    path: '/api/mention-polling/{id}/activity',
