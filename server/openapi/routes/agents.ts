...
export const agentRoutes: RouteEntry[] = [
  ...
  },
  {
    ...
    responses: {
      200: {
        ...
        example: { ...AGENT_EXAMPLE, name: 'DevAgent-v2', model: 'claude-opus-4-6' },
      },
    },
  },
  {
  ...
  },
  {
    ...
    responses: {
      200: {
        ...
        example: {
          messages: [
            { id: 'msg_001', role: 'user', content: 'Hello, start the task.', createdAt: '2026-03-22T10:01:00.000Z' },
          ],
          total: 1,
        },
      },
  ...
  {
    method: 'DELETE',
    path: '/api/agents/{id}/personas/{personaId}',
  ...
  {
    method: 'DELETE',
    path: '/api/agents/{id}/skills/{bundleId}',
