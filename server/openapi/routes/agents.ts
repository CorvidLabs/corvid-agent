...
import { CreateAgentSchema, UpdateAgentSchema, FundAgentSchema, InvokeAgentSchema, AssignSkillBundleSchema } from '../../lib/validation';
...
export const agentRoutes: RouteEntry[] = [
    ...
    { method: 'GET', path: '/api/agents/{id}/personas', summary: 'List personas assigned to agent (ordered)', tags: ['Agents', 'Personas'], auth: 'required' },
    { method: 'POST', path: '/api/agents/{id}/personas', summary: 'Assign persona to agent', tags: ['Agents', 'Personas'], auth: 'required' },
    ...
    { method: 'POST', path: '/api/personas', summary: 'Create a persona', tags: ['Personas'], auth: 'required', responses: { 201: { description: 'Created persona' } } },
    { method: 'GET', path: '/api/personas/{id}', summary: 'Get persona by ID', tags: ['Personas'], auth: 'required' },
    { method: 'PUT', path: '/api/personas/{id}', summary: 'Update persona', tags: ['Personas'], auth: 'required' },
