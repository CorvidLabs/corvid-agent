...
import { CreateSubscriptionSchema, parseBodyOrThrow, ValidationError } from '../lib/validation';
...
async function handleCreateSubscription(req: Request, billing: BillingService): Promise<Response> {
  try {
...
async function handleStripeWebhook(req: Request, billing: BillingService): Promise<Response> {
