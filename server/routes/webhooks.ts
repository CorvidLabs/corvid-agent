...
import { CreateWebhookRegistrationSchema, parseBodyOrThrow, UpdateWebhookRegistrationSchema } from '../lib/validation';
 ...
 */
export async function handleGitHubWebhook(req: Request, webhookService: WebhookService): Promise<Response> {
