...
import type { ListingCategory, PricingModel, SearchSortBy, VerificationBadge } from '../marketplace/types';
...
async function handleCreateListing(req: Request, marketplace: MarketplaceService): Promise<Response> {
  try {
...
async function handleUpdateListing(req: Request, id: string, marketplace: MarketplaceService): Promise<Response> {
  try {
...
async function handleCreateReview(req: Request, listingId: string, marketplace: MarketplaceService): Promise<Response> {
  try {
...
async function handleRegisterInstance(req: Request, federation?: MarketplaceFederation | null): Promise<Response> {
...
async function handleSyncAll(federation?: MarketplaceFederation | null): Promise<Response> {
  if (!federation) return json({ error: 'Federation not available' }, 503);
...
async function handleCancelSubscription(req: Request, subscriptionId: string, db: Database): Promise<Response> {
  const subscriptions = new SubscriptionService(db);
...
async function handleCreateTier(req: Request, listingId: string, marketplace: MarketplaceService): Promise<Response> {
  try {
...
async function handleUpdateTier(req: Request, tierId: string, marketplace: MarketplaceService): Promise<Response> {
  try {
