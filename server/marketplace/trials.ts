...
import type { MarketplaceListing, MarketplaceTrial, TrialRecord } from './types';
...
export class TrialService {
  ...
  getTrialById(id: string): MarketplaceTrial | null {
    const row = this.db.query('SELECT * FROM marketplace_trials WHERE id = ?').get(id) as TrialRecord | null;
