 ...
 */
export const OLLAMA_STALL_THRESHOLD = parseInt(process.env.OLLAMA_STALL_THRESHOLD ?? '3', 10);

/**
 * Whether auto-escalation is enabled.
 * Override with OLLAMA_STALL_ESCALATION_ENABLED=false to disable.
 */
export const OLLAMA_STALL_ESCALATION_ENABLED = process.env.OLLAMA_STALL_ESCALATION_ENABLED !== 'false';
