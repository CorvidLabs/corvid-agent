...
import type { ChannelAdapter, ChannelStatus, SessionMessage } from '../channels/types';
...
export type { LocalChatEvent, LocalChatEventFn, LocalChatSendFn } from './subscription-manager';
...
export class AlgoChatBridge implements ChannelAdapter {
  ...
  constructor(db: Database, processManager: ProcessManager, config: AlgoChatConfig, service: AlgoChatService) {
    this.db = db;
