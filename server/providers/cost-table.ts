...
export interface ModelPricing {
    ...
    model: string;
    /** Provider type */
    provider: 'anthropic' | 'openai' | 'openrouter' | 'ollama' | 'cursor';
    /** Display name */
    displayName: string;
...
export const MODEL_PRICING: ModelPricing[] = [
    ...
    // ─── OpenRouter (third-party models via OpenRouter gateway) ─────────
    {
        model: 'openai/gpt-4o',
        provider: 'openrouter',
    ...
    },
    {
        ...
        provider: 'openrouter',
        displayName: 'Command R+ (OpenRouter)',
    ...
    // ─── Cursor Agent CLI (subscription-bundled, models not available via other providers) ─
    {
        model: 'auto',
        provider: 'cursor',
    ...
    },
    {
        ...
        provider: 'cursor',
        displayName: 'Composer 2 Fast (Cursor)',
        inputPricePerMillion: 0,
        outputPricePerMillion: 0,
        maxContextTokens: 200_000,
        maxOutputTokens: 32_000,
    ...
    },
    {
        model: 'gpt-5.3-codex',
        provider: 'cursor',
        displayName: 'GPT-5.3 Codex (Cursor)',
        inputPricePerMillion: 0,
        outputPricePerMillion: 0,
        maxContextTokens: 200_000,
        maxOutputTokens: 32_000,
    ...
    },
    {
        ...
        provider: 'cursor',
        displayName: 'Gemini 3.1 Pro (Cursor)',
        inputPricePerMillion: 0,
        outputPricePerMillion: 0,
        maxContextTokens: 1_000_000,
        maxOutputTokens: 65_536,
    ...
    },
    {
        ...
        provider: 'cursor',
        displayName: 'Gemini 3 Flash (Cursor)',
        inputPricePerMillion: 0,
        outputPricePerMillion: 0,
        maxContextTokens: 1_000_000,
        maxOutputTokens: 65_536,
    ...
    },
    {
        ...
        provider: 'cursor',
        displayName: 'Grok 4.20 Thinking (Cursor)',
        inputPricePerMillion: 0,
        outputPricePerMillion: 0,
        maxContextTokens: 200_000,
        maxOutputTokens: 32_000,
    ...
    },
    {
        ...
        provider: 'ollama',
        displayName: 'Nemotron 3 Super (Cloud)',
        inputPricePerMillion: 0,
        outputPricePerMillion: 0,
        maxContextTokens: 128_000,
        maxOutputTokens: 16_000,
    ...
    },
    {
        ...
        provider: 'ollama',
        displayName: 'Qwen 3 Coder 480B (Cloud)',
        inputPricePerMillion: 0,
        outputPricePerMillion: 0,
        maxContextTokens: 128_000,
        maxOutputTokens: 32_000,
