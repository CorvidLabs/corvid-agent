...
export function buildRouteRegistry(): RouteDefinition[] {
  ...
  return [
    ...
    },
    {
      ...
      tags: ['Projects'],
      auth: false,
      requestSchema: v.CreateProjectSchema,
    },
    {
      method: 'GET',
    ...
    },
    {
      ...
      tags: ['Projects'],
      auth: false,
      requestSchema: v.UpdateProjectSchema,
      pathParams: [{ name: 'id', description: 'Project ID' }],
    },
    {
      method: 'DELETE',
    ...
    },
    {
      ...
      tags: ['Agents'],
      auth: false,
      requestSchema: v.CreateAgentSchema,
    },
    {
      method: 'GET',
      path: '/api/agents/{id}',
    ...
    },
    {
      ...
      tags: ['Agents'],
      auth: false,
      requestSchema: v.UpdateAgentSchema,
      pathParams: [{ name: 'id', description: 'Agent ID' }],
    },
    {
      method: 'DELETE',
    ...
    },
    {
      ...
      summary: 'Get agent Algorand balance',
      tags: ['Agents'],
      auth: false,
      pathParams: [{ name: 'id', description: 'Agent ID' }],
    },
    {
      ...
      tags: ['Agents'],
      auth: false,
      requestSchema: v.FundAgentSchema,
      pathParams: [{ name: 'id', description: 'Agent ID' }],
    },
    {
      method: 'POST',
      path: '/api/agents/{id}/invoke',
      summary: 'Invoke agent-to-agent message',
      tags: ['Agents'],
      auth: false,
      requestSchema: v.InvokeAgentSchema,
    ...
    },
    {
      ...
      tags: ['Sessions'],
      auth: false,
      requestSchema: v.CreateSessionSchema,
    },
    {
      method: 'GET',
    ...
    },
    {
      ...
      tags: ['Sessions'],
      auth: false,
      requestSchema: v.UpdateSessionSchema,
      pathParams: [{ name: 'id', description: 'Session ID' }],
    },
    {
      method: 'DELETE',
    ...
    },
    {
      ...
      summary: 'Send message to active session',
      tags: ['Sessions'],
      auth: false,
      pathParams: [{ name: 'id', description: 'Session ID' }],
    },
    ...
    },
    {
      ...
      tags: ['Councils'],
      auth: false,
      requestSchema: v.CreateCouncilSchema,
    },
    {
      method: 'GET',
    ...
    },
    {
      ...
      tags: ['Councils'],
      auth: false,
      requestSchema: v.UpdateCouncilSchema,
      pathParams: [{ name: 'id', description: 'Council ID' }],
    },
    {
      method: 'DELETE',
    ...
    },
    {
      ...
      summary: 'Launch council deliberation',
      tags: ['Councils'],
      auth: false,
      requestSchema: v.LaunchCouncilSchema,
      pathParams: [{ name: 'id', description: 'Council ID' }],
    },
    ...
    },
    {
      ...
      tags: ['Work Tasks'],
      auth: false,
      requestSchema: v.CreateWorkTaskSchema,
    },
    {
      method: 'GET',
      path: '/api/work-tasks/{id}',
    ...
    },
    {
      ...
      tags: ['Schedules'],
      auth: false,
      requestSchema: v.CreateScheduleSchema,
    },
    {
      method: 'GET',
    ...
    },
    {
      ...
      tags: ['Schedules'],
      auth: false,
      requestSchema: v.UpdateScheduleSchema,
      pathParams: [{ name: 'id', description: 'Schedule ID' }],
    },
    {
      method: 'DELETE',
    ...
    },
    {
      ...
      tags: ['Workflows'],
      auth: false,
      requestSchema: v.CreateWorkflowSchema,
    },
    {
      method: 'GET',
    ...
    },
    {
      ...
      tags: ['Workflows'],
      auth: false,
      requestSchema: v.UpdateWorkflowSchema,
      pathParams: [{ name: 'id', description: 'Workflow ID' }],
    },
    {
      method: 'DELETE',
    ...
    },
    {
      ...
      tags: ['Workflows'],
      auth: false,
      requestSchema: v.TriggerWorkflowSchema,
      pathParams: [{ name: 'id', description: 'Workflow ID' }],
    },
    ...
    },
    {
      ...
      tags: ['Escalation'],
      auth: false,
      requestSchema: v.EscalationResolveSchema,
    ...
    },
    {
      ...
      tags: ['System'],
      auth: false,
      requestSchema: v.OperationalModeSchema,
    },
    ...
    // ─── AlgoChat ──────────────────────────────────────────────────
    {
      ...
      summary: 'Get AlgoChat connection status',
      tags: ['AlgoChat'],
      auth: false,
    },
    {
      ...
      tags: ['AlgoChat'],
      auth: false,
      requestSchema: v.SwitchNetworkSchema,
    },
    ...
    // ─── Feed / Analytics ───────────────────────────────────────────
    {
      ...
      summary: 'Get activity feed history',
      tags: ['Feed'],
      auth: false,
      queryParams: [
    ...
    // ─── Browse Dirs ────────────────────────────────────────────────
    {
      ...
      tags: ['System'],
      auth: true,
      queryParams: [{ name: 'path', description: 'Directory path to browse', type: 'string', required: true }],
    },
    ...
    // ─── Self-Test ─────────────────────────────────────────────────
    {
      ...
      tags: ['System'],
      auth: false,
      requestSchema: v.SelfTestSchema,
    },
