...
export const COMMAND_DEFS: CommandDef[] = [
  ...
  },
  {
    ...
    usage: '/history [limit]',
    params: [{ name: 'limit', description: 'Number of transactions (default 10, max 20)', required: false }],
    privileged: false,
  ...
  },
  {
    ...
    usage: '/agent [name]',
    params: [{ name: 'name', description: 'Agent name to switch to', required: false, rest: true }],
    privileged: true,
  ...
  },
  {
    ...
    params: [{ name: 'session-id', description: 'Session ID to stop', required: true }],
    privileged: true,
  ...
  },
  {
    ...
    params: [{ name: 'queue-id', description: 'Escalation queue ID', required: true }],
    privileged: true,
    examples: ['/approve 1'],
  },
  {
  ...
  },
  {
    ...
    params: [{ name: 'mode', description: 'New operational mode', required: false }],
    privileged: true,
  ...
  },
  {
    ...
    params: [
      {
        name: 'agents-or-name',
        description: '@mentions or council name (optional)',
        required: false,
        agentMention: true,
      },
  ...
  },
  {
    ...
    params: [
      {
        name: '@agent',
        description: 'Agent to message (optional, defaults to active agent)',
        required: false,
        agentMention: true,
      },
  ...
  },
  {
    ...
    usage: '/help [command]',
    params: [{ name: 'command', description: 'Specific command to get help for', required: false }],
    privileged: false,
