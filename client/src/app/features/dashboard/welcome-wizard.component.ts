...
╚██████╗╚██████╔╝██║  ██║ ╚████╔╝ ██║██████╔╝
 ╚═════╝ ╚═════╝ ╚═╝  ╚═╝  ╚═══╝  ╚═╝╚═════╝</pre>
            ...
            @switch (step()) {
                @case ('status') {
                    <div class="wizard__step" role="group" aria-label="Step 1: System Status">
                        <h2 class="step__title">System Status</h2>
                        <p class="step__desc">Checking your environment...</p>

                        <ul class="status-grid" role="list" aria-label="System health checks">
                            <li class="status-check"
                                [attr.data-ok]="health()?.apiKey"
                ...
                @case ('create') {
                    <div class="wizard__step" role="group" aria-label="Step 2: Create Agent">
                        ...
                        <form [formGroup]="form" (ngSubmit)="onCreateAgent()" class="wizard__form" aria-label="Create agent form">
                            <div class="field">
                                ...
                                <input id="wiz-name" formControlName="name" class="field__input"
                                       ...
                                       aria-describedby="wiz-name-error" />
                                @if (form.controls.name.touched && form.controls.name.invalid) {
                                    <span id="wiz-name-error" class="field__error" role="alert">Agent name is required.</span>
                                }
                            </div>
                ...
                @case ('done') {
                    <div class="wizard__step wizard__step--done" role="group" aria-label="Step 3: Complete">
