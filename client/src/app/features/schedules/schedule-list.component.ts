...
@media(max-width:480px){.schedules{padding:1rem}.exec-stats__item{min-width:0}.exec-stats__bar{min-width:80px;flex-basis:100%}.approval-card{flex-direction:column;gap:.5rem;align-items:flex-start}.schedule-meta{grid-template-columns:1fr}.create-btn{width:100%;text-align:center}.form-buttons{display:flex;gap:.5rem}.form-buttons .save-btn,.form-buttons .action-btn{flex:1}.exec-row{flex-wrap:wrap;gap:.25rem}}`,
})
