...
@Component({
    ...
    styles: `
        ...
        code { background: var(--bg-raised); color: var(--accent-green); padding: 2px 6px; border-radius: var(--radius-sm); font-size: var(--text-caption); border: 1px solid var(--border); }
        ...
        .detail__code {
            ...
            padding: 1rem; font-size: var(--text-caption); overflow-x: auto; white-space: pre-wrap; color: var(--accent-green);
        }
        ...
        .session-row__time { margin-left: auto; font-size: var(--text-xs); color: var(--text-tertiary); }
    `,
})
