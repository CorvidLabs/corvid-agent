...
const TABS: NavTab[] = [
    ...
    },
    {
        ...
        matchRoutes: ['/observe'],
        children: [
            { label: 'Live Feed', route: '/observe' },
            { label: 'Analytics', route: '/observe/analytics' },
            { label: 'Logs', route: '/observe/logs' },
            { label: 'Brain Viewer', route: '/observe/brain-viewer' },
            { label: 'Reputation', route: '/observe/reputation' },
        ],
    },
    {
        key: 'automate',
        label: 'Automate',
        route: '/automate',
        matchRoutes: ['/automate'],
        children: [
            { label: 'Schedules', route: '/automate' },
            { label: 'Workflows', route: '/automate/workflows' },
            { label: 'Webhooks', route: '/automate/webhooks' },
            { label: 'Polling', route: '/automate/mention-polling' },
            { label: 'MCP Servers', route: '/automate/mcp-servers' },
        ],
    },
    {
        key: 'settings',
        ...
        children: [
            ...
            { label: 'Allowlist', route: '/settings/allowlist' },
            { label: 'GH Allowlist', route: '/settings/github-allowlist' },
            { label: 'Repo Blocklist', route: '/settings/repo-blocklist' },
