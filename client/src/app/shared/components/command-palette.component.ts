...
export class CommandPaletteComponent implements AfterViewInit, OnDestroy {
    ...
    private readonly allCommands = computed<CommandItem[]>(() => {
        const commands: CommandItem[] = [
            ...
            { id: 'nav-councils', label: 'Go to Councils', category: 'Navigation', icon: '👥', action: () => this.nav('/councils') },
            { id: 'nav-models', label: 'Go to Models', category: 'Navigation', icon: '🧠', action: () => this.nav('/models') },
            { id: 'nav-analytics', label: 'Go to Analytics', category: 'Navigation', icon: '📊', action: () => this.nav('/analytics') },
            { id: 'nav-logs', label: 'Go to Logs', category: 'Navigation', icon: '📜', action: () => this.nav('/logs') },
            { id: 'nav-settings', label: 'Go to Settings', category: 'Navigation', icon: '⚙️', action: () => this.nav('/settings') },
            { id: 'nav-wallets', label: 'Go to Wallets', category: 'Navigation', icon: '💰', action: () => this.nav('/wallets') },
            { id: 'nav-security', label: 'Go to Security', category: 'Navigation', icon: '🔒', action: () => this.nav('/security') },
            { id: 'nav-spending', label: 'Go to Spending', category: 'Navigation', icon: '💳', action: () => this.nav('/spending') },
            { id: 'nav-feed', label: 'Go to Live Feed', category: 'Navigation', icon: '📡', action: () => this.nav('/feed') },
            { id: 'nav-mcp', label: 'Go to MCP Servers', category: 'Navigation', icon: '🔌', action: () => this.nav('/mcp-servers') },
            { id: 'nav-skills', label: 'Go to Skill Bundles', category: 'Navigation', icon: '🎯', action: () => this.nav('/skill-bundles') },
            { id: 'nav-marketplace', label: 'Go to Marketplace', category: 'Navigation', icon: '🏪', action: () => this.nav('/marketplace') },
            { id: 'nav-reputation', label: 'Go to Reputation', category: 'Navigation', icon: '⭐', action: () => this.nav('/reputation') },
            { id: 'nav-webhooks', label: 'Go to Webhooks', category: 'Navigation', icon: '🪝', action: () => this.nav('/webhooks') },
            { id: 'nav-schedules', label: 'Go to Schedules', category: 'Navigation', icon: '🕐', action: () => this.nav('/schedules') },
            { id: 'nav-workflows', label: 'Go to Workflows', category: 'Navigation', icon: '🔄', action: () => this.nav('/workflows') },
            { id: 'nav-brain', label: 'Go to Brain Viewer', category: 'Navigation', icon: '🧩', action: () => this.nav('/brain-viewer') },
