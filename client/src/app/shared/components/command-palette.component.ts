...
export class CommandPaletteComponent implements AfterViewInit, OnDestroy {
    ...
    private readonly allCommands = computed<CommandItem[]>(() => {
        const commands: CommandItem[] = [
            ...
            { id: 'nav-logs', label: 'Go to Logs', category: 'Navigation', icon: '📜', action: () => this.nav('/sessions/logs') },
            ...
            { id: 'nav-feed', label: 'Go to Live Feed', category: 'Navigation', icon: '📡', action: () => this.nav('/sessions/feed'), keywords: 'observe activity' },
            ...
            { id: 'nav-reputation', label: 'Go to Reputation', category: 'Navigation', icon: '⭐', action: () => this.nav('/sessions/reputation') },
            ...
            { id: 'nav-brain', label: 'Go to Brain Viewer', category: 'Navigation', icon: '🧩', action: () => this.nav('/sessions/brain-viewer') },
