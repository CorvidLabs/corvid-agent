...
export class CommandPaletteComponent implements AfterViewInit, OnDestroy {
    ...
    private readonly allCommands = computed<CommandItem[]>(() => {
        const commands: CommandItem[] = [
            ...
            { id: 'nav-analytics', label: 'Go to Analytics', category: 'Navigation', icon: '📊', action: () => this.nav('/observe/analytics') },
            ...
            { id: 'nav-feed', label: 'Go to Live Feed', category: 'Navigation', icon: '📡', action: () => this.nav('/observe') },
            { id: 'nav-mcp', label: 'Go to MCP Servers', category: 'Navigation', icon: '🔌', action: () => this.nav('/automate/mcp-servers') },
            ...
            { id: 'nav-webhooks', label: 'Go to Webhooks', category: 'Navigation', icon: '🪝', action: () => this.nav('/automate/webhooks') },
            { id: 'nav-schedules', label: 'Go to Schedules', category: 'Navigation', icon: '🕐', action: () => this.nav('/automate') },
            { id: 'nav-workflows', label: 'Go to Workflows', category: 'Navigation', icon: '🔄', action: () => this.nav('/automate/workflows') },
