...
@Component({
    ...
    styles: `
        ...
        .status-badge--loading { background: var(--accent-cyan-dim); color: var(--accent-cyan); border-color: var(--accent-cyan-border); }
        ...
        .status-badge--thinking { background: var(--accent-purple-dim); color: var(--accent-purple); border-color: var(--accent-purple-border); animation: statusPulse 1.5s ease-in-out infinite; }
        .status-badge--tool_use { background: var(--accent-cyan-dim); color: var(--accent-cyan); border-color: var(--accent-cyan-border); animation: statusPulse 1s ease-in-out infinite; }
        ...
        .status-badge--queued { background: var(--accent-amber-dim); color: var(--accent-yellow); border-color: var(--accent-amber-border); }
        ...
        .status-badge--validating { background: var(--accent-cyan-dim); color: var(--accent-cyan); border-color: var(--accent-cyan-border); animation: statusPulse 1.5s ease-in-out infinite; }
