...
| `getRecentMentionSessions` | `db: Database, maxAgeHours?: number` | `Array<{ botMessageId, info, createdAt }>` | Returns mention sessions created within the specified hours for recovery |
